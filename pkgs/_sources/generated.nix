...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  clash-for-windows = {
    ...
    version = "0.20.36";
    src = fetchurl {
      url = "https://github.com/Fndroid/clash_for_windows_pkg/releases/download/0.20.36/Clash.for.Windows-0.20.36-x64-linux.tar.gz";
      sha256 = "sha256-6snyI3SKTQGbOnVdoWxM5QN4zPyKnO524oCE4mhfO58=";
    };
  };
  ...
  waybar-git = {
    pname = "waybar-git";
    version = "16f6d9dfa0c38d72e6c661334e4c9d7837b3a61d";
    src = fetchgit {
      url = "https://github.com/Alexays/Waybar.git";
      rev = "16f6d9dfa0c38d72e6c661334e4c9d7837b3a61d";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-Tu8Dsvqb018HxqkecyC5eTCfWCM5A1e7cuAJ9aKS6cE=";
    };
    date = "2023-09-24";
  };
  yacd = {
