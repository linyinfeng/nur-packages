...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  clash-for-windows = {
    ...
    version = "0.20.24";
    src = fetchurl {
      url = "https://github.com/Fndroid/clash_for_windows_pkg/releases/download/0.20.24/Clash.for.Windows-0.20.24-x64-linux.tar.gz";
      sha256 = "sha256-XHnv9jPCNhorbTPJ2yvwCNRKgiu6CdpGLQfI0F47atc=";
    };
  };
  ...
  rime-cantonese = {
    ...
    version = "7deee0414739239a346e75d869ea3dd91c03bdff";
    src = fetchgit {
      url = "https://github.com/rime/rime-cantonese.git";
      rev = "7deee0414739239a346e75d869ea3dd91c03bdff";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-VhXNGlET/XGA9sToWfwi95ouhgARYhAslP9CbW9TXDM=";
    };
    date = "2023-05-28";
  };
  rime-double-pinyin = {
  ...
  rime-ice = {
    pname = "rime-ice";
    version = "6f68577360b0f911428782010b2e6e51598f17db";
    src = fetchgit {
      url = "https://github.com/iDvel/rime-ice.git";
      rev = "6f68577360b0f911428782010b2e6e51598f17db";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-DwVluMCZH/JVKurtYH9p9duQ1E+VDSG3XaXHXV0inPY=";
    };
    date = "2023-05-27";
  };
  rime-loengfan = {
