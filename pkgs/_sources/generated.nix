...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  rime-ice = {
    pname = "rime-ice";
    version = "f276d4de87fd31b52a39116a94a3a8292fa1cbc6";
    src = fetchgit {
      url = "https://github.com/iDvel/rime-ice.git";
      rev = "f276d4de87fd31b52a39116a94a3a8292fa1cbc6";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-cAq9EiLL9dhulorsPrtp9p2ORfFD0a4Zfwcrpat5D0g=";
    };
    date = "2023-10-14";
  };
  rime-loengfan = {
  ...
  waybar-git = {
    ...
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-eYZv+c2t+WKpa0t6c6xD8CvUqvm3WqdDlvzJ1Td6E14=";
    };
    date = "2023-10-12";
  };
  yacd = {
