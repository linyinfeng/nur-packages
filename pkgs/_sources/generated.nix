...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  rime-cantonese = {
    ...
    version = "7ffbef96c145f3d4030ff47f62ab6e1eb96da018";
    src = fetchgit {
      url = "https://github.com/rime/rime-cantonese.git";
      rev = "7ffbef96c145f3d4030ff47f62ab6e1eb96da018";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-xyRH/OmUo7AHw4bqFqqs1Qpd9K0HOzCRWjos8zD6pUA=";
    };
    date = "2023-04-13";
  };
  rime-double-pinyin = {
  ...
  rime-ice = {
    pname = "rime-ice";
    version = "10943c808a459d157cb9d97544148977f80ef1b7";
    src = fetchgit {
      url = "https://github.com/iDvel/rime-ice.git";
      rev = "10943c808a459d157cb9d97544148977f80ef1b7";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-MHGCzQWKJb4zU2RM0QPCBGlV/9gKnQIYpnkb5SCMHsU=";
    };
    date = "2023-04-25";
  };
  rime-loengfan = {
  ...
  waybar-git = {
    ...
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-1lCH2z9QvZ7icsxPsacEJQrohXxBxKLa3oS5D5N1EW4=";
    };
    date = "2023-04-23";
  };
  wemeet = {
