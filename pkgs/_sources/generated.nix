...
}:
{
  ...
  rime-essay = {
    pname = "rime-essay";
    version = "e5e718c26b1069d443e5b2967e7404c8c0b63a6e";
    src = fetchgit {
      url = "https://github.com/rime/rime-essay.git";
      rev = "e5e718c26b1069d443e5b2967e7404c8c0b63a6e";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-4MYrdUHakpi6sKuFhjbeZBXJffKi+QCGyzoE4Q8NjIo=";
    };
    date = "2025-02-19";
  };
  rime-ice = {
  ...
  rime-luna-pinyin = {
    ...
    version = "308b8efc39917b99765e8a3792ad274aaabe5de1";
    src = fetchgit {
      url = "https://github.com/rime/rime-luna-pinyin.git";
      rev = "308b8efc39917b99765e8a3792ad274aaabe5de1";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-SZs4u09XqGfD8j4gz1N5fLTts79m0jIJ/asS2riplWA=";
    };
    date = "2025-02-24";
  };
  rime-pinyin-simp = {
