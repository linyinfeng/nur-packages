...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  rime-ice = {
    pname = "rime-ice";
    version = "bb0fdea74c5d7bd7836cbe02dcc530aba260fc9c";
    src = fetchgit {
      url = "https://github.com/iDvel/rime-ice.git";
      rev = "bb0fdea74c5d7bd7836cbe02dcc530aba260fc9c";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-7ruafclgb5yYSEMd1uepJk+N/gntfK+4Fz0ruy5/GYo=";
    };
    date = "2023-10-30";
  };
  rime-loengfan = {
  ...
  waybar-git = {
    ...
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-iWSykdFBTxAydsEB2ye/wQDZ17rOH1k9FnaGUGfgKSs=";
    };
    date = "2023-10-27";
  };
  yacd = {
