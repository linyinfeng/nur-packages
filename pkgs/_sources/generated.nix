...
}:
{
  ...
  linux-intel-lts = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "lts-v6.6.30-linux-240508T063812Z";
      fetchSubmodules = false;
  ...
  rime-ice = {
    pname = "rime-ice";
    version = "95b1f4fdc0658498c1154caed309e133230c692b";
    src = fetchgit {
      url = "https://github.com/iDvel/rime-ice.git";
      rev = "95b1f4fdc0658498c1154caed309e133230c692b";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-A/g90FMcoVUp1nLzt3N3YECD0exhFitZytHuxCI0Zcw=";
    };
    date = "2024-05-21";
  };
  rime-loengfan = {
  ...
  waybar-git = {
    ...
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-CLlApn6c6xWLx8r0rvKT4KQKWOQ6fbPjUat6GNOXCck=";
    };
    date = "2024-05-18";
  };
  yacd = {
