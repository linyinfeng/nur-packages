...
{ fetchgit, fetchurl }:
{
  clash-for-windows = {
    ...
    version = "0.18.9";
    src = fetchurl {
      url = "https://github.com/Fndroid/clash_for_windows_pkg/releases/download/0.18.9/Clash.for.Windows-0.18.9-x64-linux.tar.gz";
      sha256 = "0q2ciyjmgh7pbiwa7jrakw3rfkvcx18kg47l12q7vg0z7qjcszzs";
    };
  };
  ...
  commit-notifier = {
    ...
    version = "1e1e554c7d2b82e53afba3c9f17267e92b46e99f";
    src = fetchgit {
      url = "https://github.com/linyinfeng/commit-notifier.git";
      rev = "1e1e554c7d2b82e53afba3c9f17267e92b46e99f";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "11x17pnfpnnij913h5m3qxn5rxpi1sdvjqhkasybvz2rjj83rwh9";
    };
    cargoLock = {
      lockFile = ./commit-notifier-1e1e554c7d2b82e53afba3c9f17267e92b46e99f/Cargo.lock;
      outputHashes = { };
    };
  };
  dot-tar = {
  ...
  plugin-git = {
    pname = "plugin-git";
    version = "e4484b870c11fd010fe8f6071b79a50f7a0eec5a";
    src = fetchgit {
      url = "https://github.com/jhillyerd/plugin-git";
      rev = "e4484b870c11fd010fe8f6071b79a50f7a0eec5a";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "18yxq0kzadn9rkdswm0n35l27h6c6l7irz8syx14067zrmsby364";
    };
  };
  replay-fish = {
    pname = "replay-fish";
