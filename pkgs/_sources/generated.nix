...
}:
{
  ...
  rime-essay = {
    pname = "rime-essay";
    version = "569415cc3780d104ea34725b325a345bfce980eb";
    src = fetchgit {
      url = "https://github.com/rime/rime-essay.git";
      rev = "569415cc3780d104ea34725b325a345bfce980eb";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-SbBEhtTuSMcLHOaSRNtkzQGSW0Qtm+zjFtiCSnnZ49E=";
    };
    date = "2025-01-31";
  };
  rime-ice = {
    ...
    src = fetchgit {
      ...
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-+oPCl9tmcBrbsAL3cZkSR9v7CxYMAaSJLwmp3eUjAlA=";
    };
    date = "2025-02-02";
  };
  rime-loengfan = {
