...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  clash-for-windows = {
    ...
    version = "0.20.31";
    src = fetchurl {
      url = "https://github.com/Fndroid/clash_for_windows_pkg/releases/download/0.20.31/Clash.for.Windows-0.20.31-x64-linux.tar.gz";
      sha256 = "sha256-VRtQyzUPE7ZKNY/qpqEPo6Fy6QJgVzMnSLLqZhJHEFQ=";
    };
  };
  ...
  waybar-git = {
    pname = "waybar-git";
    version = "aecd80702e746e7cb9a78c70d0578a88547341b1";
    src = fetchgit {
      url = "https://github.com/Alexays/Waybar.git";
      rev = "aecd80702e746e7cb9a78c70d0578a88547341b1";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-CkiIR66543f5kK76snBTEJRJ5ikyBXBOVqUgvZi6nk4=";
    };
    date = "2023-08-16";
  };
  wemeet = {
