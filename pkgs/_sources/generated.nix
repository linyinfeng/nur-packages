...
}:
{
  ...
  linux-intel-lts = {
    ...
    version = "lts-v6.6.25-linux-240425T033651Z";
    src = fetchFromGitHub {
      owner = "intel";
      repo = "linux-intel-lts";
      rev = "lts-v6.6.25-linux-240425T033651Z";
      fetchSubmodules = false;
      sha256 = "sha256-fVgLbLLwYDnrJ6Oe8FdxhDVmpajoO/YrVZxcY1tviEo=";
    };
  };
  lpac = {
    pname = "lpac";
  ...
  waybar-git = {
    ...
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-EUXcIg8BVH0t2WH8pZB4HJglovs2AD1jI3t9kyMejEw=";
    };
    date = "2024-05-06";
  };
  yacd = {
