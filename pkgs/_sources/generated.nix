...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  icalingua-plus-plus = {
    ...
    version = "v2.9.10";
    src = fetchurl {
      url = "https://github.com/icalingua-plus-plus/icalingua-plus-plus/releases/download/v2.9.10/app-x86_64.asar";
      sha256 = "sha256-ZTYyjFX5gdrL7c/5JDwXo+1x3vq1upVC5vr9UeJro7A=";
    };
  };
  matrix-chatgpt-bot = {
  ...
  rime-ice = {
    pname = "rime-ice";
    version = "3e24a1ee202054f776f188ba82e86fa30f16ab55";
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-/Cr2suW5opg4uDe4qib+IIozYwmz/EqIZs90fSI4RD8=";
    };
    date = "2023-05-09";
  };
  rime-loengfan = {
