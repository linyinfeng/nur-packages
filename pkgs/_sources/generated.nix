...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  clash-for-windows = {
    ...
    version = "0.20.38";
    src = fetchurl {
      url = "https://github.com/Fndroid/clash_for_windows_pkg/releases/download/0.20.38/Clash.for.Windows-0.20.38-x64-linux.tar.gz";
      sha256 = "sha256-aBrhcpsUGg061P/08c/YmO4q+O1nLoOow7ENA4f7lj0=";
    };
  };
  ...
  rime-ice = {
    pname = "rime-ice";
    version = "f02c4341d47cb504ba69fb19e3b9047fa04d8246";
    src = fetchgit {
      url = "https://github.com/iDvel/rime-ice.git";
      rev = "f02c4341d47cb504ba69fb19e3b9047fa04d8246";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-rla2q3Ae+dkrx35MK7Jq+sLbyx7mWSbFcJ4wi6xVPeU=";
    };
    date = "2023-10-17";
  };
  rime-loengfan = {
  ...
  waybar-git = {
    pname = "waybar-git";
    version = "42741c963e89ad21d8af4cb53aa3d5771e0bbad0";
    src = fetchgit {
      url = "https://github.com/Alexays/Waybar.git";
      rev = "42741c963e89ad21d8af4cb53aa3d5771e0bbad0";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-ckI2e3kZNrJuJgi7neSw/SPPtZlE/aCnQzWAQAMH2wk=";
    };
    date = "2023-10-16";
  };
  yacd = {
