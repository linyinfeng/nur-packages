...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  clash-for-windows = {
    ...
    version = "0.20.10";
    src = fetchurl {
      url = "https://github.com/Fndroid/clash_for_windows_pkg/releases/download/0.20.10/Clash.for.Windows-0.20.10-x64-linux.tar.gz";
      sha256 = "sha256-RINC9PoxpTxNYTgOr2CJQ9UErJuMFjwbP+6opQiHPog=";
    };
  };
  ...
  icalingua-plus-plus-aur = {
    ...
    version = "230814a9f207f8386ec6e6ebb87a8b2866698603";
    src = fetchgit {
      url = "https://aur.archlinux.org/icalingua++.git";
      rev = "230814a9f207f8386ec6e6ebb87a8b2866698603";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-4WchBMOS8oLzL1GsGlnicjpJ2fwC5sMpZhOqpLP5dCQ=";
    };
  };
  linux-qq = {
    pname = "linux-qq";
