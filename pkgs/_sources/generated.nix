...
{ fetchgit, fetchurl }:
{
  clash-for-windows = {
    ...
    version = "0.18.8";
    src = fetchurl {
      url = "https://github.com/Fndroid/clash_for_windows_pkg/releases/download/0.18.8/Clash.for.Windows-0.18.8-x64-linux.tar.gz";
      sha256 = "1a5bj6kwv54wwafan3c957cbyhzf5qni8g01808fgvja0kdzgl33";
    };
  };
  ...
  icalingua = {
    ...
    version = "v2.4.2";
    src = fetchurl {
      url = "https://github.com/Clansty/Icalingua/releases/download/v2.4.2/app-x86_64.asar";
      sha256 = "01l00a2iqjvbc70z78mn1sm4pqg6ln5ac053qzccxznf4gdl4xrg";
    };
  };
  icalinguaIcon = {
    pname = "icalinguaIcon";
