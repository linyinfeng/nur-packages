...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  clash-for-windows = {
    ...
    version = "0.20.27";
    src = fetchurl {
      url = "https://github.com/Fndroid/clash_for_windows_pkg/releases/download/0.20.27/Clash.for.Windows-0.20.27-x64-linux.tar.gz";
      sha256 = "sha256-3q3CohIj4BaedHRx6cDPqVu/lkW9ZTTyhzQqoFC4U9E=";
    };
  };
  ...
  rime-ice = {
    pname = "rime-ice";
    version = "d9cf59d5f2a186c130a2b7362ace848276a507a8";
    src = fetchgit {
      url = "https://github.com/iDvel/rime-ice.git";
      rev = "d9cf59d5f2a186c130a2b7362ace848276a507a8";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-a0oakjTVH5ll91fGdsPQlMTodWWCROVWpmqZTCTy/SU=";
    };
    date = "2023-06-29";
  };
  rime-loengfan = {
